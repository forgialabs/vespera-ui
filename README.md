...
| [`@vespera-ui/react`](./packages/react) | React components (flagship).                                 | ✅ primitives (preview) |
| [`@vespera-ui/icons`](./packages/icons) | Framework-neutral SVG icon set.                              | ✅ ported (preview)     |
