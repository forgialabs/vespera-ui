...
function DocsSection({ sub = 'start', onSub }) {
  ...
  return (
    <>
      ...
      <p className="doc-lede" style={{ marginTop: 10 }}>Aether is a copy-in component library. There's no package to install and no runtime: you copy the token CSS plus the file(s) for the components you actually use. Nothing you don't reference ships in your bundle.</p>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 28, maxWidth: 760 }}>
      <div>
        ...
        <p className="doc-p" style={{ margin: '6px 0 12px' }}>Aether components are plain React (no build step needed for prototyping). Include React, the design tokens, and the component CSS.</p>
...
const RELEASES = [
  ...
  { v: '1.0.0', date: 'Jun 8, 2026', items: [['Added', 'Initial Aether design system + Admin template — tokens, light/dark, density, primitives, charts, showcase.']] },
];
