...
- **GitHub Releases** — notes for every published version:
  [github.com/forgialabs/docs/releases](https://github.com/forgialabs/docs/releases)
- **Per-package changelogs** — each package has a `CHANGELOG.md` in the repo
  (e.g. [`packages/react/CHANGELOG.md`](https://github.com/forgialabs/docs/blob/main/packages/react/CHANGELOG.md)).
...
becomes the release note. See [Contributing](https://github.com/forgialabs/docs/blob/main/CONTRIBUTING.md#changesets).
