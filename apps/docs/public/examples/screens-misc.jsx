    ...
    <div className="ag-content-inner" style={{ maxWidth: 1080 }}>
      <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 'var(--gap)', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--gap)' }}>
          ...
          {tab === 'Workspace' && <CardForm title="Workspace" desc="Organization-wide defaults." fields={[['Workspace name', 'Vespera Labs Inc.'], ['Workspace URL', 'aether.dev/acme'], ['Default timezone', 'UTC−05:00 · Eastern']]} />}
