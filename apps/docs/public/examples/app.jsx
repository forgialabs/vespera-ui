...
const NAV = [
  ...
  { group: 'Resources', items: [
    { id: 'library', label: 'Design system', icon: 'database', href: 'library.html' },
  ]},
];
...
function App() {
  ...
  const cmdGroups = [
    { label: 'Navigate', items: [
      ...
      { label: 'Open design system library', icon: 'database', onRun: () => { window.location.href = 'library.html'; } },
    ]},
    ...
    <aside className="ag-side">
      <div className="ag-brand">
        ...
        <div className="ag-brand-text">
          <div className="ag-brand-name">Vespera</div>
...
function Topbar({ title, crumb, t, setTweak, onOpenCmd, createOpen, setCreateOpen, go }) {
  return (
    <header className="ag-top">
      ...
      <a className="btn btn-ghost btn-sm" href="library.html" title="Back to component library"><Icon.database />Library</a>
